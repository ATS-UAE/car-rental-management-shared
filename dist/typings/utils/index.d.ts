 ...
 */
export declare type PartialKeys<T, K extends keyof T> = Partial<Pick<T, K>> &
	Omit<T, K>;
export declare type FlattenIfArray<T> = T extends (infer R)[] ? R : T;
export declare type ExtractServerResponseData<T> = T extends ServerResponse<
	infer Data
>
	? Data
	: T;
...
export declare type UseParameters<
	AllParams,
...
export declare type ReplaceAttributes<
