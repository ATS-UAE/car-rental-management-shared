...
export declare type UserServerResponseGet = ServerResponse<
	DatePropsToUnix<UserAttributes>
>;
export declare type UserServerResponseGetAll = ServerResponse<
	DatePropsToUnix<UserAttributes>[]
>;
export declare type UserServerParamsPatch = DatePropsToUnix<
	UseParameters<
	...
	>
>;
export declare type UserServerParamsPost = DatePropsToUnix<
	UseParameters<
		RemoveImmutableSequelizeProperties<UserAttributes>,
		| "clientId"
		| "email"
