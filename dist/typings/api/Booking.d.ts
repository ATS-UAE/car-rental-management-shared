...
export declare type BookingServerResponseGet = ServerResponse<
	DatePropsToUnix<BookingAttributes>
>;
export declare type BookingServerResponseGetAll = ServerResponse<
	DatePropsToUnix<ExtractServerResponseData<BookingServerResponseGet>>[]
>;
export declare type BookingServerParamsPatch = DatePropsToUnix<
	UseParameters<
		BookingAttributes,
		never,
		| "userId"
	...
	>
>;
export declare type BookingServerParamsPost = DatePropsToUnix<
	UseParameters<
