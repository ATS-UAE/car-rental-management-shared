...
export declare type AccidentServerResponseGet = ServerResponse<
	DatePropsToUnix<AccidentAttributes>
>;
export declare type AccidentServerResponseGetAll = ServerResponse<
	DatePropsToUnix<AccidentAttributes>[]
>;
export declare type AccidentServerParamsPatch = DatePropsToUnix<
...
export declare type AccidentServerParamsPost = DatePropsToUnix<
	UseParameters<
